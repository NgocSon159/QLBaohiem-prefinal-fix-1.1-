...
namespace Model.Dao
{
    public class GoiHopDongDao
    {
        ...
        public void ThemGHD(string MaHD,string MucPhi,string GiaTriBaoHiem,int ThoiHanBaoHiem,int ThoiHanDongPhi)
        {
            GoiHopDong gh = new GoiHopDong();
            gh.MaGoiHD = MaHD;
            gh.MucPhi = Convert.ToDecimal(MucPhi);
            gh.GiaTriBaoHiem = Convert.ToDecimal(GiaTriBaoHiem);
