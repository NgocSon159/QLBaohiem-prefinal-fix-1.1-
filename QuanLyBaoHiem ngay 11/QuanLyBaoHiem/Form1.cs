...
namespace QuanLyBaoHiem
{
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public void phanquyenQuanLy()
        {
            ...
            //btnQuanLyKhachHang.Links[0].Visible = false;
        ...
        public void phanquyenNhanVien()
        {
            ...
            //btnCaNhanNV.Links[0].Visible = false;
            btnInfor.Links[0].Visible = true;
            btnQuanLyChucVu.Links[0].Visible = false;
        }
        ...
        {
            ucThongTinNhanVien ucThongTinNhanVien = new ucThongTinNhanVien();
            AddTabControl(ucThongTinNhanVien, "Thông Tin Nhân Viên", "");
        }
        ...
        {
            ucTkThongTin ucTkThongTin = new ucTkThongTin();
            AddTabControl(ucTkThongTin, "Tìm kiếm hợp đồng", "");
        }

        private void btnTimKiemKhachHang_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ucTkKhachHang ucTkKhachHang = new ucTkKhachHang();
            AddTabControl(ucTkKhachHang, "Tìm kiếm khách hàng", "");
        }
